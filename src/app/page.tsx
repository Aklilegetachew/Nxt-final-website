          ...
          <div className="container-grid">
            <div className="text-center mb-16">
              ...
              <p className="text-body-lg text-text-subtle max-w-3xl mx-auto">
                We&apos;re a software development firm that helps our clients
                succeed with innovative, software-centric solutions. We design,
                integrate, and support cutting-edge media and communication
